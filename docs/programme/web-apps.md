...
* Read what BlockingQueue is, try out some examples [link](https://www.baeldung.com/java-blocking-queue)
...
* Read about [ThreadPools](https://www.baeldung.com/thread-pool-java-and-guava), 
[Executors](https://www.baeldung.com/java-executor-service-tutorial) . 
Try to write some sample tasks and submit them to the pool for execution.
